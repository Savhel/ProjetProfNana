...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Pas de données",sInfo:"De _START_ à _END_ des _TOTAL_ données",sInfoEmpty:"De 0 à 0 des 0 données",
sInfoFiltered:"(cherché dans les _MAX_ données)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affiche _MENU_ données",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune données trouvées"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
